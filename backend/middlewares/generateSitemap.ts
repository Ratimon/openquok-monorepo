...
/** Keep in sync with scripts/generate-routes-manifest.mjs. */
...
function extractPublicApiPlatformSlugs(constantsDir: string): string[] {
...
function buildPublicApiMarketingSitemapPaths(constantsDir: string): string[] {
