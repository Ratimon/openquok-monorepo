...
function externalCdnImageBaseHeaders(): Record<string, string> {
    return {
        "User-Agent":
...
/**
 * Instagram CDN expects an Instagram Referer. Facebook `scontent` / lookaside and LinkedIn
 * `media.licdn.com` signed URLs 403 when a site Referer is sent from a datacenter IP — omit it.
 */
