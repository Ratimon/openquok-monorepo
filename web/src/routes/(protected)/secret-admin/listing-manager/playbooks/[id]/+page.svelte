<script lang="ts">
	...
	import { getRootPathSecretAdminListingManagerPlaybooks } from '$lib/area-admin/constants/getRootPathSecretAdminArea';
	...
	const stacksListHref = url(getRootPathSecretAdminListingManagerPlaybooks());
...
<div class="p-4 md:p-6">
	<div class="mb-6">
		<h1 class="text-xl font-semibold text-base-content">Edit playbook</h1>
