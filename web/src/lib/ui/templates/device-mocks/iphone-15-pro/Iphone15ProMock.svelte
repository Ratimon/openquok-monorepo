...
>
	...
	{#if children}
		<foreignObject
			...
			width="389.5"
			height="843.5"
			clip-path="url(#iphone-mock-rounded-corners)"
		>
			<div xmlns="http://www.w3.org/1999/xhtml" class="size-full overflow-hidden rounded-[55.75px]">
				{@render children()}
			</div>
		</foreignObject>
	{:else if src}
	...
	/>
	<defs>
		<clipPath id="iphone-mock-rounded-corners">
