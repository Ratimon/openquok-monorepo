<script lang="ts">
	...
	import ListingInlineMarkdown from '$lib/ui/templates/listings/ListingInlineMarkdown.svelte';
		...
		{#each blocks as block, index (index)}
			...
			{:else if block.type === 'table'}
				<div class={buildingBlockCatalogTableShellClass}>
					<table class={buildingBlockCatalogTableClass}>
						<thead>
							<tr>
								{#each block.headers as header, headerIndex (headerIndex)}
									<th class={buildingBlockCatalogTableHeadCellClass}>
