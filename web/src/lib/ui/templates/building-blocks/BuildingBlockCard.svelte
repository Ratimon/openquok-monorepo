<script lang="ts">
	...
	import BuildingBlockCardExpanded from '$lib/ui/templates/building-blocks/BuildingBlockCardExpanded.svelte';
...
>
	...
	<Collapsible.Content class="border-t border-base-content/10 px-4 pb-4">
		<BuildingBlockCardExpanded extensionVm={extensionVm} detailHref={detailHref} />
	</Collapsible.Content>
</Collapsible.Root>
</div>
