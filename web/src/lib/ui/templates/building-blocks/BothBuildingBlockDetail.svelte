...
<section class="py-8">
	<Tabs.Root bind:value={activeModality} class="w-full space-y-8">
		<Tabs.List class={buildingBlockDetailTabsListClass}>
			<Tabs.Trigger value="skills" class={buildingBlockDetailTabTriggerClass}>Skills</Tabs.Trigger>
			<Tabs.Trigger value="mcp" class={buildingBlockDetailTabTriggerClass}>MCP</Tabs.Trigger>
		</Tabs.List>
