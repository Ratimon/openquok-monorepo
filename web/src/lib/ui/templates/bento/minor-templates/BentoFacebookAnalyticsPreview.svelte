<script lang="ts">
	...
	import { buildFacebookLandingAnalyticsVm } from './facebookLandingAnalyticsMock';
	...
	let platformFilterVm = $state({
		...
		selectedSocialPlatformIdentifiers: ['facebook']
	});
	...
	const analyticsVm = $derived(buildFacebookLandingAnalyticsVm(dateWindowDays));
