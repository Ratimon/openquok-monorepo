<script lang="ts">
	...
	import BentoLinkedinAnalyticsPreview from '$lib/ui/templates/bento/minor-templates/linkedin/BentoLinkedinAnalyticsPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(36rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoLinkedinAnalyticsPreview}
	/>
</BentoGridOneCol>
