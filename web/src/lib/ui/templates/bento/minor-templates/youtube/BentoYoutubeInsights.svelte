<script lang="ts">
	...
	import BentoYoutubeAnalyticsPreview from '$lib/ui/templates/bento/minor-templates/youtube/BentoYoutubeAnalyticsPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(36rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoYoutubeAnalyticsPreview}
	/>
</BentoGridOneCol>
