<script lang="ts">
	...
	import { buildYoutubeLandingAnalyticsVm } from './youtubeLandingAnalyticsMock';
	...
	let platformFilterVm = $state({
		...
		selectedSocialPlatformIdentifiers: ['youtube']
	});
	...
	const analyticsVm = $derived(buildYoutubeLandingAnalyticsVm(dateWindowDays));
