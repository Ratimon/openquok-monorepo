<script lang="ts">
	...
	import BentoYoutubeKanbanPreview from '$lib/ui/templates/bento/minor-templates/youtube/BentoYoutubeKanbanPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(22rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoYoutubeKanbanPreview}
	/>
</BentoGridOneCol>
