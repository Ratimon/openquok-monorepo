<script lang="ts">
	...
	import BentoLandingComposerPreview from '$lib/ui/templates/bento/minor-templates/landing/BentoLandingComposerPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(22rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoLandingComposerPreview}
	/>
</BentoGridOneCol>
