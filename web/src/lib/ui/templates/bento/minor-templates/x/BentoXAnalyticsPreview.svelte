<script lang="ts">
	...
	import { buildXLandingAnalyticsVm } from '$lib/ui/templates/bento/minor-templates/x/xLandingAnalyticsMock';
	...
	let platformFilterVm = $state({
		...
		selectedSocialPlatformIdentifiers: ['x']
	});
	...
	const analyticsVm = $derived(buildXLandingAnalyticsVm(dateWindowDays));
...
<div class="bg-base-100 text-base-content">
	<section class="space-y-3 border-b border-base-300 px-4 py-4">
		<div class="flex flex-wrap items-center justify-between gap-3">
			<h3 class="text-base font-semibold text-base-content">Targeted channels</h3>
	...
	<section class="space-y-3 px-4 py-4">
		<h3 class="text-base font-semibold text-base-content">Overview</h3>
		<RenderAnalyticsGrid
