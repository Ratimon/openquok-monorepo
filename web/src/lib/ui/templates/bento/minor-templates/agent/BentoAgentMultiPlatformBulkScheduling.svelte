<script lang="ts">
	...
	import BentoAgentMultiPlatformKanbanPreview from '$lib/ui/templates/bento/minor-templates/agent/BentoAgentMultiPlatformKanbanPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(22rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoAgentMultiPlatformKanbanPreview}
	/>
</BentoGridOneCol>
