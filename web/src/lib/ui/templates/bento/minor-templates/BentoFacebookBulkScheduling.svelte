<script lang="ts">
	...
	import BentoFacebookCreatePostPreview from '$lib/ui/templates/bento/minor-templates/BentoFacebookCreatePostPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(22rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoFacebookCreatePostPreview}
	/>
</BentoGridOneCol>
