<script lang="ts">
	...
	import BentoDevtoAnalyticsPreview from '$lib/ui/templates/bento/minor-templates/devto/BentoDevtoAnalyticsPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(36rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoDevtoAnalyticsPreview}
	/>
</BentoGridOneCol>
