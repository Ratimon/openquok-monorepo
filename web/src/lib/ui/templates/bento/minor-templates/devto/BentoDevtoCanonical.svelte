<script lang="ts">
	...
	import BentoDevtoCanonicalPreview from '$lib/ui/templates/bento/minor-templates/devto/BentoDevtoCanonicalPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(22rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoDevtoCanonicalPreview}
