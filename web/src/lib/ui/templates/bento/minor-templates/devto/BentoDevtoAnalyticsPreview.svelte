<script lang="ts">
	...
	import { buildDevtoLandingAnalyticsVm } from '$lib/ui/templates/bento/minor-templates/devto/devtoLandingAnalyticsMock';
	...
	let platformFilterVm = $state({
		...
		selectedSocialPlatformIdentifiers: ['devto']
	});
	...
	const analyticsVm = $derived(buildDevtoLandingAnalyticsVm(dateWindowDays));
