<script lang="ts">
	...
	import BentoTiktokAnalyticsPreview from '$lib/ui/templates/bento/minor-templates/tiktok/BentoTiktokAnalyticsPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(36rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoTiktokAnalyticsPreview}
	/>
</BentoGridOneCol>
