<script lang="ts">
	...
	import { buildTiktokLandingAnalyticsVm } from './tiktokLandingAnalyticsMock';
	...
	let platformFilterVm = $state({
		...
		selectedSocialPlatformIdentifiers: ['tiktok']
	});
	...
	const analyticsVm = $derived(buildTiktokLandingAnalyticsVm(dateWindowDays));
