<script lang="ts">
	...
	import BentoBlueskyKanbanPreview from '$lib/ui/templates/bento/minor-templates/bluesky/BentoBlueskyKanbanPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(22rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoBlueskyKanbanPreview}
	/>
</BentoGridOneCol>
