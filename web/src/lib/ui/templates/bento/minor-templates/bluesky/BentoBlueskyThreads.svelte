<script lang="ts">
	...
	import BentoBlueskyComposerPreview from '$lib/ui/templates/bento/minor-templates/bluesky/BentoBlueskyComposerPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(22rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoBlueskyComposerPreview}
		backgroundProps={{ isLoggedIn, variant: 'threads' }}
	/>
</BentoGridOneCol>
