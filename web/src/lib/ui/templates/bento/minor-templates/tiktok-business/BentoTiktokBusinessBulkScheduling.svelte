<script lang="ts">
	...
	import BentoTiktokBusinessKanbanPreview from '$lib/ui/templates/bento/minor-templates/tiktok-business/BentoTiktokBusinessKanbanPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(22rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoTiktokBusinessKanbanPreview}
	/>
</BentoGridOneCol>
