<script lang="ts">
	...
	import BentoTiktokBusinessComposerPreview from '$lib/ui/templates/bento/minor-templates/tiktok-business/BentoTiktokBusinessComposerPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(22rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoTiktokBusinessComposerPreview}
