<script lang="ts">
	...
	import BentoInstagramAnalyticsPreview from '$lib/ui/templates/bento/minor-templates/instagram/BentoInstagramAnalyticsPreview.svelte';
...
<BentoGridOneCol class={cn('auto-rows-[minmax(36rem,auto)]', className)}>
	<BentoCard
		...
		background={BentoInstagramAnalyticsPreview}
	/>
</BentoGridOneCol>
