...
<TooltipPortal {...portalProps}>
	<TooltipPrimitive.Content
		...
		{side}
		class={cn(
			'z-50 max-w-72 overflow-hidden rounded-md border border-base-300 bg-base-100 px-3 py-2 text-left text-xs leading-relaxed text-wrap text-base-content shadow-md',
