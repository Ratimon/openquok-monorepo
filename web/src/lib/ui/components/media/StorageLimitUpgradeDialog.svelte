...
>
	<Dialog.Content class="max-w-lg" showCloseButton>
		<Dialog.Header>
			<Dialog.Title>Upgrade for more storage</Dialog.Title>
			<Dialog.Description>
				This workspace has reached its media storage limit. Upgrade to a higher plan for more cloud
				storage, or delete files to free space.
			</Dialog.Description>
		</Dialog.Header>
		<Dialog.Footer>
			<Dialog.Close>
