...
const YOUTUBE_CHANNEL: PublicChannelLandingPage = {
	...
	heroTitle: 'Schedule YouTube video uploads you approve',
	heroDescription:
		'Connect a YouTube channel you manage, attach one MP4 per post, set title privacy tags and thumbnail in the composer, and publish through the official Google APIs — from the calendar, public API, or CLI.',
	metaTitle: 'YouTube Video Upload Scheduler',
	metaDescription:
		'Schedule YouTube video uploads with OpenQuok. Connect your channel, queue MP4 uploads with title, privacy, tags, and optional thumbnail, and track channel analytics from one workspace.',
	keywords: [
	...
	featureSections: [
		{
			subtitle: 'Bulk scheduling',
			title: 'Queue YouTube uploads, batch MP4 posts, weeks ahead',
			description:
				'Schedule video uploads onto the calendar for days or weeks ahead. Review agent and human drafts on the kanban board, then move them to Scheduled when you are ready to publish.',
			bentoId: 'youtube-bulk-scheduling',
			mediaOnRight: true
		},
		{
			subtitle: 'Video settings',
			title: 'Set title, privacy, tags, and thumbnail, in one place',
			description:
				'Attach a single MP4, write the video description as your post body, and tune YouTube-specific settings — title, public or unlisted privacy, made-for-kids, tags, and an optional custom thumbnail — before publish.',
	...
	audienceCards: [
		{
			...
			description:
				'Queue long-form uploads and tutorials on a calendar instead of manual YouTube Studio publishing. Set privacy and tags per video before it goes live.',
			containerClass: 'h-full min-h-[18rem]'
		},
		{
			iconName: icons.CustomizedDrawnLaptop.name,
			...
			title: 'Marketing teams',
			description:
				'Batch product walkthroughs and launch videos ahead of time. Review drafts, attach thumbnails, and keep one MP4-per-post workflow consistent across the team.',
			containerClass: 'h-full min-h-[18rem]'
		},
		{
			iconName: icons.CustomizedDrawnRobot.name,
	...
	faqDescription:
		'Common questions about connecting a YouTube channel, scheduling MP4 uploads, and using OpenQuok with Google APIs.',
	faqItems: [
		{
		...
		},
		{
			...
			description:
				'Each scheduled YouTube post needs exactly one MP4 attachment. The composer validates format before publish; attach your video file from the media library or upload via the API.'
		},
		{
			title: 'Can I set the video title, privacy, and tags in OpenQuok?',
			description:
				'Yes. Use YouTube settings in the composer (or pass flat keys or a youtube bucket via providerSettings in the API). Title, privacy (public, unlisted, or private), made-for-kids, tags, and an optional custom thumbnail are supported.'
		},
		{
			title: 'Does the post body become the YouTube description?',
			description:
				'Yes. The main post text maps to the video description on upload. Keep copy within the 5,000-character limit shown in the composer.'
		},
		{
		...
		{
			title: 'Does OpenQuok support YouTube Shorts or playlists?',
			description:
				'Not today. OpenQuok schedules standard MP4 video uploads to channels you manage — not Shorts-specific publishing, playlists, or YouTube-side scheduled publish times.'
		},
		{
