...
export const publicFaqHref = {
	...
	billing: faqHrefDocs('billing'),
	billingLimits: faqHrefDocs('billing/limits'),
	billingSubscription: faqHrefDocs('billing/subscription'),
	billingDowngrades: faqHrefDocs('billing/downgrades'),
	cloud: faqHrefDocs('cloud'),
	cloudTrial: faqHrefDocs('cloud/trial'),
	cloudPlans: faqHrefDocs('cloud/plans'),
	docsQuickstart: faqHrefDocs('getting-started/quickstart'),
	docsGlossary: faqHrefDocs('getting-started/glossary'),
	docsCreatingPosts: faqHrefDocs('creating-posts'),
	docsSchedulingRepeat: `${faqHrefDocs('creating-posts/scheduling')}#repeating-a-post`,
	docsKanban: faqHrefDocs('posts-management/kanban'),
	docsCalendar: faqHrefDocs('posts-management/calendar'),
	...
	docsPlaybooksExplore: faqHrefDocs('playbooks/explore-and-bookmarks'),
	docsPlaybooksMyLibrary: faqHrefDocs('playbooks/my-library'),
	docsPlaybooksCompose: faqHrefDocs('playbooks/compose-a-playbook'),
	docsThreadsComments: faqHrefDocs('creating-posts/threads-and-comments'),
	docsAiGeneration: faqHrefDocs('creating-posts/ai-generation'),
	docsChannelGroups: faqHrefDocs('channels/channel-groups'),
	docsManageChannels: faqHrefDocs('channels/manage'),
	docsConnectRules: faqHrefDocs('platforms/connect-rules'),
	docsHelp: faqHrefDocs('help'),
