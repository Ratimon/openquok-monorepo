...
export const brandedIcons = {
    ...
    /** Claw Post product mark. Claw Post is a trademark of Daydream Nation Tech Labs, LLC. */
    ClawPost: {
        name: "ClawPost",
        box: 512,
        fill: true,
    ...
    /**
     * DEV classic badge (white on black rounded square).
     * Letterforms from the official brand assets at https://dev.to/brand (Black DEV / rainbow badge).
     * DEV Community is a trademark of Forem.
     */
    Devto: {
        name: "Devto",
        box: 235,
        boxHeight: 234,
        fill: true,
        svg: `<rect width="235" height="234" rx="8" fill="#0A0A0A"/><g transform="translate(37 77)" fill="#fff"><path d="M28.2371517,0.75 C32.7510836,1.7 36.0111455,3.55 39.371517,7.05 C42.4309598,10.25 44.3368421,13.9 45.1393189,18 C45.7913313,21.45 45.7913313,58.55 45.1393189,62.05 C43.4340557,71.15 35.6600619,78.25 26.0303406,79.5 C24.0241486,79.75 17.3034056,80 11.1845201,80 L0,80 L0,0 L12.4383901,0 C21.2656347,0 25.7795666,0.2 28.2371517,0.75 Z M14.5448916,40 L14.5448916,65.6 L19.7108359,65.4 C24.174613,65.25 25.1275542,65.05 27.1337461,63.9 C31.0458204,61.6 31.0959752,61.45 31.0959752,39.7 C31.0959752,18.5 31.0959752,18.5 27.4346749,16.1 C25.6291022,14.9 24.8767802,14.75 19.9616099,14.55 L14.5448916,14.4 L14.5448916,40 Z"/><path d="M93.7894737,7.25 L93.7894737,14.5 L68.2105263,14.5 L68.2105263,32.5 L83.7585139,32.5 L83.7585139,47 L68.2105263,47 L68.3108359,56.1 L68.4613003,65.25 L81.1504644,65.4 L93.7894737,65.5 L93.7894737,80 L78.993808,80 C62.5430341,80 59.9851393,79.7 57.3770898,77.4 C53.7157895,74.2 53.9164087,76.25 53.7659443,41.1 C53.6656347,19.2 53.8160991,8.85 54.1671827,7.45 C54.8693498,4.85 57.828483,1.65 60.4365325,0.75 C61.9913313,0.2 65.9034056,0.05 78.1411765,0 L93.7894737,0 L93.7894737,7.25 Z"/><path d="M125.437152,28.1 C129.148607,42.35 132.258204,53.7 132.358514,53.35 C132.508978,53 135.668731,40.95 139.430341,26.5 L146.301548,0.25 L154.125697,0.1 C160.043963,0 162,0.15 162,0.6 C162,1.05 144.64644,66.8 143.643344,70.1 C142.941176,72.4 139.179567,77.1 137.073065,78.35 C134.414861,79.85 130.502786,80.1 128.095356,78.85 C125.9387,77.75 123.079876,74.45 121.625387,71.35 C120.722601,69.45 105.97709,15.35 102.566563,1.35 L102.21548,0 L110.039628,0 C117.713313,0 117.913932,0 118.31517,1.1 C118.515789,1.75 121.725697,13.9 125.437152,28.1 Z"/></g>`
    },
    /** DEV classic badge tile (same mark as Devto). DEV Community is a trademark of Forem. */
    DevtoGlyph: {
        name: "DevtoGlyph",
        box: 235,
        boxHeight: 234,
    ...
    /** Later product mark. Later is a trademark of its respective owner. */
    Later: {
        name: "Later",
        box: 24,
        fill: true,
        svg: `<rect width="24" height="24" rx="6" fill="#0A0A0A"/><image href="/icons/later.png" x="1.5" y="7.4" width="21" height="9.2"/>`
    },
    /** Hopper HQ product mark. Hopper HQ is a trademark of its respective owner. */
    HopperHQ: {
        name: "HopperHQ",
        box: 21,
        boxHeight: 21,
        fill: true,
        svg: `<path fill="#246BEB" d="M17.944 0.064H2.921A2.92 2.92 0 0 0 .856.892 2.92 2.92 0 0 0 0 2.894l1.128 7.284L0 17.456c0 .751.308 1.472.856 2.003.548.531 1.291.829 2.066.828h15.023c1.613 0 2.919-1.268 2.919-2.833l-1.128-7.284L20.865 2.888C20.86 1.327 19.554.064 17.944.064Zm-2.945 10.577-.769 6.282h-3.04l.766-6.282c.031-.225.042-.452.031-.678a1.24 1.24 0 0 0-.867-.514 1.24 1.24 0 0 0-1.238.199c-.224.238-.419.5-.581.781-.187.323-.337.665-.453 1.02l-.666 5.232h-3.04l1.787-14.27h3.04l-.714 5.678c.412-.456.913-.868 1.526-1.1.501-.23 1.048-.35 1.602-.351.403-.005.801.08 1.164.288.353.166.65.415.876.725.252.354.419.748.503 1.175.098.531.108 1.073.03 1.607v.012Z"/><path fill="#1456CC" fill-rule="evenodd" clip-rule="evenodd" d="M17.944.064H2.921A2.92 2.92 0 0 0 .856.892 2.92 2.92 0 0 0 0 2.894l1.128 7.284 4.933-.006.942-7.526h3.04l-.714 5.678c.412-.456.913-.868 1.526-1.1.501-.23 1.048-.35 1.602-.351.403-.005.801.08 1.164.288.353.166.65.415.876.725.252.354.419.748.503 1.175.074.377.099.761.074 1.144h4.705l1.128-7.284C20.856 1.327 19.554.064 17.944.064Z"/>`
    },
    ...
    /** Muse Code terminal agent tile mark. Muse Code is a trademark of Meta. */
    MuseCode: {
        name: "MuseCode",
        box: 64,
        fill: true,
        svg: `<rect width="64" height="64" rx="10" fill="#0D131C"/><path d="M13 45V19h7l12 15 12-15h7v26h-8V31L32 44 21 31v14z" fill="#EEF4FA"/><path d="M46 13h7l-9 38h-7z" fill="#52D5FF"/>`
    },
    // from https://dashboardicons.com/
...
`
    ...
    /** UseBard product mark. UseBard is a trademark of its respective owner. */
    UseBard: {
        name: "UseBard",
        box: 24,
        fill: true,
        svg: `<rect width="24" height="24" rx="5.5" fill="#7C3AED"/><path fill="#fff" d="M14.75 6.5v7.55a2.45 2.45 0 1 1-1.25-2.1V8.9l-5.25 1.55v6.2a2.45 2.45 0 1 1-1.25-2.1V7.45l7.75-1z"/>`
    },
    Warp: {
        name: "Warp",
        box: 24,
