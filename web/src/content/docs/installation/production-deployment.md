...
<p>To run API, web, Redis, and BullMQ workers on your own host from this monorepo, follow <a href="/docs/installation/docker-compose">Docker Compose (self-host)</a>. After <code>docker compose … up --build</code>, open the UI at <code>http://localhost:4007</code> (API at <code>http://localhost:3000</code>). That path still needs an operator-provided Supabase project; see <a href="/docs/installation/system-requirements">System requirements</a>. To upgrade an existing install, see <a href="/docs/installation/docker-compose#update">Update to a newer version</a>.</p>
</Callout>
