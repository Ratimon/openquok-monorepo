...
The frontend base URL used in OAuth redirect URIs comes from <Badge text="FRONTEND_DOMAIN_URL" variant="envBackend" /> (default <Badge text="http://localhost:5173" variant="new" /> for local Vite).
...
See <a href="/docs/contribution-opportunities/add-provider">Adding a social provider</a> for the full backend + web checklist used when implementing Facebook and future channels.
</Callout>
