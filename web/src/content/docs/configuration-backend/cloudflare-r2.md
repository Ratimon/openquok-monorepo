...
Set these in <Badge text="web/.env.development.local" variant="envBackend" /> (or your production web env). Restart Vite after changes. See also <a href="/docs/configuration-web/vite">Vite (SvelteKit)</a>.
...
<LinkCard title="Vite (SvelteKit)" description="Vite variables and frontend origin alignment" href="/docs/configuration-web/vite" />
</CardGrid>
