...
<p>On <strong>ThinkRail</strong>, install the skill under <code>~/.pi/agent/skills/</code> or the worktree <code>.pi/skills/</code> — see <a href="/docs/agent-setup-guides/thinkrail">ThinkRail agent guide</a>.</p>
